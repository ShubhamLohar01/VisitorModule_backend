...
class S3Service:
    ...
    def __init__(self):
        ...
        # On Lambda, let boto3 use IAM role credentials automatically.
        # On local dev, pass explicit credentials from .env/settings.
        ...
        logger.info(f"S3 service initialized: bucket={self.bucket_name}, region={self.region}, lambda={is_lambda}")
