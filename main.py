...
async def startup_event():
    ...
    pass  # Migration moved to module level for Lambda compatibility
...
@app.post("/google-form", status_code=201)
def google_form_no_prefix_endpoint(
    form_data: GoogleFormSubmission,
    background_tasks: BackgroundTasks,
    db: Session = Depends(get_db)
):
    """Google Form endpoint without /api prefix for Apps Script compatibility"""
    return google_form_submission(form_data, background_tasks, db)
